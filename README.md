...
Please report any issue to the [Issue Tracker](https://github.com/idseefeld/PostgreSqlForUmbraco/issues).
...
### Wiki
Further details are in the [Wiki](https://github.com/idseefeld/PostgreSqlForUmbraco/wiki) of this project.
