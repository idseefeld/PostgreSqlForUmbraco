...
{
    public class PostgreSqlAddDbConnection : DbConnection
    {
        private NpgsqlConnection _inner;

        public PostgreSqlAddDbConnection(NpgsqlConnection npgsqlConnection) => _inner = npgsqlConnection;
        ...
        private sealed class CommandWrapper : DbCommand
        {
            ...
            protected override DbConnection? DbConnection
            {
                ...
                set => _inner.Connection = (value as PostgreSqlAddDbConnection)?._inner;
            }
